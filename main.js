...
function goToCards() {
    ...
    const specialCards = [
        { img: "fcpoints.png", amount: 100000, label: "Fc Points" },
        { img: "diamantes.png", amount: 100000, label: "Diamonds" },
    ...
    <div style="color:black;font-size:18px;font-weight:bold;margin-top:6px;">
      ${item.amount}
...
function goToSearching() {
    ...
    setTimeout(() => {
      ...
      <div style="color:black;font-size:15px;margin-top:6px;">
        ${amountText}
      </div>
    `;
